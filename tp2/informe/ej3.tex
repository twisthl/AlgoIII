...
La complejidad real de bfs es $O(n + m)$ \footnote{reference $Introduction to Algorithms 3° ed. - Cormen, Leiserson, Rivest, Stein - pag. 597$}(m = #aristas, n = #vertices). Pero en este caso decimos que la complejidad de BFS es $O(n)$ porque siempre se ejecutará sobre \'arboles. 
