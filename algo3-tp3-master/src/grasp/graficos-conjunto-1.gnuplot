...
#plot 'resultadosTestConfiguracion-conjunto-1.txt' using 1:2 pt 7 notitle
#
#reset
#set terminal jpeg size 800,600
...
#plot 'resultadosTestConfiguracion-conjunto-1.txt' using 1:4 pt 7 notitle
#
#reset
#set terminal jpeg size 800,600
...
#reset
#set terminal jpeg size 800,600
#set output "ejercicio-5-tiempos-grasp-primeros-nodos-conjunto-1.jpg"
#set key top left
#set yrange[0:]
#set xrange[2:15]
#set xtics 1
...
#set ylabel "Tiempo promedio en microsegundos"
#set title "Tiempos de ejecución de GRASP en función de n"
#plot 'tiemposGrasp-conjunto-1.txt' using 1:3 title "Max. iter. = 100 | prof. vértice-conjunto = 4 4", \
#     'tiemposGrasp-conjunto-1.txt' using 1:5 title "Iter. sin mejora = 70 | prof. vértice-conjunto = 4 4"
